...
export default function NewApplicationSubmitted({
  userName,
}: {
  userName: string;
}) {
          ...
          <Container className="my-[40px] bg-white">
            ...
            <Section className="mt-[35px]">
              ...
              <Text className="m-0 mt-[15px] text-[14px] px-[35px] text-[#97909D]">
                Hey admin, a new application has been submitted by {userName}.
                Please review the application from the dashboard.
              </Text>
            </Section>
