...
export default function AccountCreated({ userName }: { userName: string }) {
  return (
          ...
          <Container className="my-[40px] bg-white">
            ...
            <Section className="mt-[35px]">
              ...
              <Text className="m-0 mt-[15px] text-[14px] px-[35px] text-[#97909D]">
                Hey {userName}, thanks for using Responsble.ai! Your account has
                been created successfully. Now you can get your business
                certified by submitting a simple form.
              </Text>
            </Section>
