...
export default function CertificateAssigned({
  userName,
}: {
  userName: string;
}) {
  return (
    <Html lang="en" dir="ltr">
      <Head>
        <title>Certificate Assigned</title>
          ...
          <Container className="my-[40px] bg-white">
            ...
            <Section className="mt-[35px]">
              ...
              <Text className="m-0 mt-[15px] text-[14px] px-[35px] text-[#97909D]">
                Hey {userName}, congratulations! Your business has been
                certified by Responsble.ai. Please login to dashboard to view
                the certificate.
              </Text>
            </Section>
